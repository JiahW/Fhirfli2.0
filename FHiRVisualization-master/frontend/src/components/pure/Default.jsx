            ...
            <div>
                <div className="containerr">
                    ...
                    <div id="centered">
                        ...
                        <br></br>
                        <p>Use <strong>FHiR</strong> FLI 2.0 to provide a unified platform for all your health data.</p>
                ...
                <div id="about-container">
                    <div id="about-content">
                        ...
                        <div style={{marginLeft: "20px", width: "300px"}}>
                            ...
                            <p>Use FHiR FLI 2.0 to provide detailed visualisations on annonymised health data for employees registered with your company</p>
                        ...
                        <div style={{marginLeft: "20px", width: "330px"}}>
                            ...
                            <p>FHiR FLI 2.0 can aggregate your wearable data into a single platform under a medical format, allowing you to easily share that data with clinicians</p>
